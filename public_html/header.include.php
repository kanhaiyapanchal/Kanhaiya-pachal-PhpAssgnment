<?php
$path = 'http://assginment-portal.localhost/';
  ...
  <header class="bg-light fixed-top ">
    <nav>
      <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="d-flex p-3 d-none d-md-block">
          <img class="img-fluid rounded-circle img-user" src="<?php echo $path; ?>asset/img/developer.png" alt="kp" />
          <span class="px-4 mt-2"><strong>Kanhaiya Panchal</strong></span>
        </div>
      </div>
    </nav>
  </header>
        ...
        <div class="col-12 col-md-3 mt-3 " id="sideBar">
          <div class="bubble-top ">
            <div class="sidebardiv">
              ...
              <div>
                <p>
                  <a class="btn tech-button" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
                    aria-expanded="false" aria-controls="multiCollapseExample1"><svg xmlns="http://www.w3.org/2000/svg"
                      ...
                      <ul class="list-unstyled">
                        <li>
                          <a class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment1.php' ? 'active' : ''; ?>  sourse-link"
                            data-bs-toggle="collapse" href="#module1" role="button" aria-expanded="false"
                          ...
                          <div class="collapse  multi-collapse mx-5" id="module1">
                            <ul class="list-unstyled ul-assginmnet">
                              <li>
                                <a href="<?php echo $path; ?>components/module1/asgnment1.php"
                                  class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment1.php' ? 'active-link' : ''; ?>  asgment-link">
                                  Assginment 1
                                </a>
                              </li>
                            </ul>
                        ...
                        <li>
                          <a class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment1_m2.php' ? 'active' : ''; ?> sourse-link"
                            data-bs-toggle="collapse" href="#module2" role="button" aria-expanded="false"
                          ...
                          <div class="collapse  multi-collapse mx-5" id="module2">
                            <ul class="list-unstyled ul-assginmnet">
                              <li>
                                <a href="<?php echo $path; ?>components/module2/asgnment1_m2.php"
                                  class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment1_m2.php' ? 'active-link' : ''; ?>  asgment-link">
                                  Assginment-01
                                </a>
                              </li>
                            </ul>
                        ...
                        <li>
                          <a class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment1_m3.php' ? 'active' : ''; ?> sourse-link"
                            data-bs-toggle="collapse" href="#module3" role="button" aria-expanded="false"
                          ...
                          <div class="collapse  multi-collapse mx-5" id="module3">
                            <ul class="list-unstyled ul-assginmnet">
                              <li>
                                <a href="<?php echo $path; ?>components/module3/asgnment1_m3.php"
                                  class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment1_m3.php' ? 'active-link' : ''; ?>  asgment-link">
                                  Assginment-01
                                </a>
                              </li>
                              <li>
                                <a href="<?php echo $path; ?>components/module3/asgnment2_m3.php"
                                  class="<?php echo basename($_SERVER['PHP_SELF']) == 'asgnment2_m3.php' ? 'active-link' : ''; ?>  asgment-link">
                                  Assginment-02
                                </a>
                              </li>
                            </ul>
